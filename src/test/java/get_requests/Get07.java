...
*/
    ...
    public void test7(){
        ...
        List<Object> list= jsonPath.getList(""); //parametre verilmezse liste oldugu gibi gelir
        List<Object> idList= jsonPath.getList("id"); //parametre id oldugu icin id listesi verir

        List<Object> list1= jsonPath.getList("findAll{it.id>190}"); /*groovy dili ile javada sorgulama yaptik
        list oldugu icin direkt findAll ile basladik. liste olmasaydi "dosyaAdi.findAll" seklinde olacakti*/

        //Print all ids greater than 190 on the console
        System.out.println(list1);

        List<Object> list2= jsonPath.getList("findAll{it.id>190}.title");//id>190 olanlarin title alinir sadece

        //Assert that there are 10 ids greater than 190
        assertEquals(10, list1.size());

        //Print all userIds whose ids are less than 5 on the console
        List<Integer> list3= jsonPath.getList("findAll{it.id<5}.userId");
        ...
        List<String> list4= jsonPath.getList("findAll{it.id<5}.title");
        System.out.println(list4);

        //Assert that "delectus aut autem" is one of the titles whose id is less than 5
        assertTrue(list4.contains("delectus aut autem"));
